...
const I = {
...
}, ut = I.create('<div class="note-editor note-frame card"></div>'), ft = I.create('<div class="note-toolbar card-header" role="toolbar"></div>'), tt = I.create('<div class="note-editing-area"></div>'), et = I.create('<textarea class="note-codable" aria-multiline="true"></textarea>'), pt = I.create(
...
), Bt = I.create('<div class="note-editor note-airframe"></div>'), Ot = I.create(
  [
    '<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>',
    '<output class="note-status-output" role="status" aria-live="polite"></output>'
  ].join("")
), mi = I.create('<div class="note-btn-group btn-group"></div>'), gi = I.create(
  ...
  function(i, t) {
    t.fade && i.addClass("fade"), i.attr({
      ...
      [
        ...
        t.title ? '<div class="modal-header"><h4 class="modal-title">' + t.title + '</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button></div>' : "",
  ...
  return {
    ...
    createLayout: function(t) {
      const e = (i.airMode ? Bt([tt([et(), Ot()])]) : i.toolbarPosition === "bottom" ? ut([tt([et(), pt()]), ft(), mt()]) : ut([ft(), tt([et(), pt()]), mt()])).render();
