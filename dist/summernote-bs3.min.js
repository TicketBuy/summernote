...
const jt = ["sans-serif", "serif", "monospace", "cursive", "fantasy"];
function Wt(i) {
  return c.inArray(i.toLowerCase(), jt) === -1 ? `'${i}'` : i;
}
function fe() {
  const i = "mw", t = "20px";
  ...
  function a(l, h) {
    s.clearRect(0, 0, 40, 20), s.font = t + " " + Wt(l) + ', "' + h + '"', s.fillText(i, 40 / 2, 20 / 2);
...
function ze(i, t) {
  return i.length ? qt(i).reduce(function(o, n) {
    const s = bt(o);
...
const wt = R("TABLE"), Gt = R("DATA");
function it(i) {
  return !St(i) && !xt(i) && !Ze(i) && !_(i) && !wt(i) && !yt(i) && !Gt(i);
}
function xt(i) {
...
function lo(i, t) {
  return rt(i) && Qt(i.node, t);
}
function co(i, t) {
  return Q(i) && Jt(i.node, t);
}
function K(i) {
  let t = 0;
...
function ie(i) {
  if (i.nextSibling && i.parent === i.nextSibling.parent)
    return z(i.nextSibling) ? i.nextSibling : ie(i.nextSibling);
}
function ne(i, t) {
...
function dt(i, t) {
    ...
    return i.node.splitText(i.offset);
  {
    ...
    return $t(l, a), e || (Ht(i.node), Ht(l)), n && (q(i.node) && X(i.node), q(l)) ? (X(l), i.node.nextSibling) : l;
  }
}
function se(i, t, e) {
...
class E {
  ...
  nativeRange() {
    if (T.isW3CRangeSupport) {
      ...
      return t.setEndPoint("EndToEnd", Mt({
        node: this.ec,
        offset: this.eo
      })), t;
    }
...
class Lo {
  constructor(t) {
    this.bullet = new le(), this.options = t.options;
  }
  /**
   * insert tab
   *
  ...
  initialize() {
    ...
    this.$statusbar.on("mousedown touchstart", (t) => {
      ...
      const e = this.$editable.offset().top - this.$document.scrollTop(), o = this.$codable.offset().top - this.$document.scrollTop(), n = (s) => {
        let a = s.type == "mousemove" ? s : s.originalEvent.touches[0], l = a.clientY - (e + zt), h = a.clientY - (o + zt);
  ...
  createVideoNode(t) {
    ...
    if (n && n[1].length === 11) {
      ...
      if (typeof n[2] < "u") {
        ...
        if (ht)
          for (var Nt = [3600, 60, 1], Z = 0, ue = Nt.length; Z < ue; Z++)
            G += typeof ht[Z + 1] < "u" ? Nt[Z] * parseInt(ht[Z + 1], 10) : 0;
        else
          G = parseInt(n[2], 10);
      }
      ...
      var It = 0;
      g[3] !== "undefined" && (It = g[3]);
      var At = 0;
      g[4] !== "undefined" && (At = g[4]);
      var Pt = 0;
      g[5] !== "undefined" && (Pt = g[5]);
      var Lt = 0;
      g[6] !== "undefined" && (Lt = g[6]), L = c('<iframe allowfullscreen sandbox="allow-same-origin allow-scripts allow-popups">').attr("frameborder", 0).attr("src", "//" + g[1] + "/videos/embed/" + g[2] + "?loop=" + At + "&autoplay=" + Pt + "&muted=" + Lt + (lt > 0 ? "&start=" + lt : "") + (It > 0 ? "&end=" + G : "")).attr("width", "560").attr("height", "315");
    ...
    if (!f.contains([x.code.ENTER, x.code.UP, x.code.DOWN], t.keyCode)) {
      ...
      if (this.hints.length && n) {
        ...
        s && (s.top -= a.top, s.left -= a.left, this.$popover.hide(), this.lastWordRange = o, this.hints.forEach((l, h) => {
          ...
          left: s.left,
          top: s.top - this.$popover.outerHeight() - Bt
        }) : this.$popover.css({
          left: s.left,
          top: s.top + s.height + Bt
        }));
      } else
        this.hide();
    }
...
const I = {
...
}, ut = I.create('<div class="note-editor note-frame panel panel-default"></div>'), ft = I.create('<div class="panel-heading note-toolbar" role="toolbar"></div>'), tt = I.create('<div class="note-editing-area"></div>'), et = I.create('<textarea class="note-codable" aria-multiline="true"></textarea>'), pt = I.create('<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>'), mt = I.create([
  ...
  "</div>",
  "</div>"
].join("")), Ot = I.create('<div class="note-editor note-airframe"></div>'), Ut = I.create([
  '<div class="note-editable" contentEditable="true" role="textbox" aria-multiline="true"></div>',
  '<output class="note-status-output" role="status" aria-live="polite"></output>'
].join("")), mi = I.create('<div class="note-btn-group btn-group"></div>'), gi = I.create('<ul class="note-dropdown-menu dropdown-menu"></ul>', function(i, t) {
  const e = Array.isArray(t.items) ? t.items.map(function(o) {
    ...
    return '<li aria-label="' + n + '"><a href="#" ' + (l + h) + ">" + s + "</a></li>";
  }).join("") : t.items;
  i.html(e).attr({ "aria-label": t.title }), t && t.codeviewKeepButton && i.addClass("note-codeview-keep");
}), bi = function(i, t) {
  return i + " " + Rt(t.icons.caret, "span");
}, vi = I.create('<ul class="note-dropdown-menu dropdown-menu note-check"></ul>', function(i, t) {
  const e = Array.isArray(t.items) ? t.items.map(function(o) {
    const n = typeof o == "string" ? o : o.value || "", s = t.template ? t.template(o) : o;
    return '<li aria-label="' + o + '"><a href="#" data-value="' + n + '">' + Rt(t.checkClassName) + " " + s + "</a></li>";
  }).join("") : t.items;
  i.html(e).attr({ "aria-label": t.title }), t && t.codeviewKeepButton && i.addClass("note-codeview-keep");
  ...
  t.fade && i.addClass("fade"), i.attr({
    ...
    t.title ? '<div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true">&times;</button><h4 class="modal-title">' + t.title + "</h4></div>" : "",
...
}), wi = I.create('<div class="checkbox"></div>', function(i, t) {
  i.html([
    "<label" + (t.id ? ' for="note-' + t.id + '"' : "") + ">",
    '<input type="checkbox"' + (t.id ? ' id="note-' + t.id + '"' : ""),
    t.checked ? " checked" : "",
